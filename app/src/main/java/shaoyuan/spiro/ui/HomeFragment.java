...
public  class SettingsFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // guidelines.
        bindPreferenceSummaryToValue(findPreference("usePeriodUuid"));
        bindPreferenceSummaryToValue(findPreference("patientUuid"));
        bindPreferenceSummaryToValue(findPreference("patientName"));
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.pref_fragment, null);
    }
    @Override
